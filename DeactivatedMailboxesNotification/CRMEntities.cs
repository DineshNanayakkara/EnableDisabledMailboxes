...
namespace DeactivatedMailboxesNotification
{
	...
	public partial class Mailbox : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<MailBoxCheck.MailboxState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((MailBoxCheck.MailboxState)(System.Enum.ToObject(typeof(MailBoxCheck.MailboxState), optionSet.Value)));
				}
				else
				{
					return null;
	...
	public partial class CrmServiceContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// </summary>
		public System.Linq.IQueryable<MailBoxCheck.Mailbox> MailboxSet
		{
			get
			{
				return this.CreateQuery<MailBoxCheck.Mailbox>();
			}
		}
	}
}
